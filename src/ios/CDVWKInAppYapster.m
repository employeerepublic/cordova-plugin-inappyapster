...
#pragma mark CDVWKInAppYapster

@interface CDVWKInAppYapster () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVWKInAppYapster

static CDVWKInAppYapster* instance = nil;
...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVWKInAppYapsterViewController alloc] initWithUserAgent:userAgent prevUserAgent:[self.commandDelegate userAgent] browserOptions: browserOptions];
...
- (void)show:(CDVInvokedUrlCommand*)command withNoAnimate:(BOOL)noAnimate
{
    ...
    __block CDVInAppYapsterNavigationController* nav = [[CDVInAppYapsterNavigationController alloc]
                                                        initWithRootViewController:self.inAppBrowserViewController];
    nav.orientationDelegate = self.inAppBrowserViewController;
    nav.navigationBarHidden = YES;
    nav.modalPresentationStyle = self.inAppBrowserViewController.modalPresentationStyle;
    
    __weak CDVWKInAppYapster* weakSelf = self;
...
{
    // Ensure a message handler bridge is created to communicate with the CDVWKInAppYapsterViewController
...
@end //CDVWKInAppYapster

#pragma mark CDVWKInAppYapsterViewController

@implementation CDVWKInAppYapsterViewController
...
- (id)initWithUserAgent:(NSString*)userAgent prevUserAgent:(NSString*)prevUserAgent browserOptions: (CDVInAppYapsterOptions*) browserOptions
{
    self = [super init];
    if (self != nil) {
        ...
        self.webViewUIDelegate = [[CDVWKInAppYapsterUIDelegate alloc] initWithTitle:[[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleDisplayName"]];
...
- (void)navigateTo:(NSURL*)url
{
    ...
    if (_userAgentLockToken != 0) {
        ...
        __weak CDVWKInAppYapsterViewController* weakSelf = self;
...
@end //CDVWKInAppYapsterViewController
