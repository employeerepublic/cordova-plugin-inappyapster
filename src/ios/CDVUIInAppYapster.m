...
#pragma mark CDVUIInAppYapster

@interface CDVUIInAppYapster () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVUIInAppYapster

static CDVUIInAppYapster* instance = nil;
...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVUIInAppYapsterViewController alloc] initWithUserAgent:userAgent prevUserAgent:[self.commandDelegate userAgent] browserOptions: browserOptions];
...
- (void)show:(CDVInvokedUrlCommand*)command
{
    ...
    __weak CDVUIInAppYapster* weakSelf = self;
...
#pragma mark CDVUIInAppYapsterViewController

@implementation CDVUIInAppYapsterViewController
...
- (void)navigateTo:(NSURL*)url
{
    ...
    if (_userAgentLockToken != 0) {
        ...
        __weak CDVUIInAppYapsterViewController* weakSelf = self;
